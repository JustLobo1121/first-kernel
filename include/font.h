...
const unsigned char font8x8[128][8] = {
    ...
    ['0'] = {0x3C,0x66,0x6E,0x76,0x66,0x66,0x3C,0x00}, ['1'] = {0x18,0x38,0x58,0x18,0x18,0x18,0x7E,0x00},
    ['2'] = {0x3C,0x66,0x06,0x1C,0x30,0x60,0x7E,0x00}, ['3'] = {0x3C,0x66,0x06,0x1C,0x06,0x66,0x3C,0x00},
    ['4'] = {0x1C,0x3C,0x6C,0xCC,0xFE,0x0C,0x0C,0x00}, ['5'] = {0x7E,0x60,0x7C,0x06,0x06,0x66,0x3C,0x00},
    ...
    ['@'] = {0x7C,0x82,0x9A,0xAA,0xAA,0x9E,0x7C,0x00}, ['A'] = {0x18,0x3C,0x66,0x7E,0x66,0x66,0x66,0x00},
    ...
    ['H'] = {0x66,0x66,0x66,0x7E,0x66,0x66,0x66,0x00}, ['I'] = {0x3E,0x1C,0x1C,0x1C,0x1C,0x1C,0x3E,0x00},
    ['J'] = {0x0E,0x06,0x06,0x06,0x66,0x66,0x3C,0x00}, ['K'] = {0x66,0x6C,0x78,0x70,0x78,0x6C,0x66,0x00},
    ['L'] = {0x60,0x60,0x60,0x60,0x60,0x60,0x7E,0x00}, ['M'] = {0xC3,0xE7,0xFF,0xDB,0xC3,0xC3,0xC3,0x00},
    ['N'] = {0x66,0x76,0x7E,0x7E,0x6E,0x66,0x66,0x00}, ['O'] = {0x3C,0x66,0x66,0x66,0x66,0x66,0x3C,0x00},
    ['P'] = {0x7C,0x66,0x66,0x7C,0x60,0x60,0x60,0x00}, ['Q'] = {0x3C,0x66,0x66,0x66,0x6A,0x6C,0x3A,0x00},
    ...
    ['V'] = {0x66,0x66,0x66,0x66,0x66,0x3C,0x18,0x00}, ['W'] = {0xC3,0xC3,0xC3,0xDB,0xFF,0xE7,0xC3,0x00},
    ['X'] = {0x66,0x66,0x3C,0x18,0x3C,0x66,0x66,0x00}, ['Y'] = {0x66,0x66,0x66,0x3C,0x18,0x18,0x18,0x00},
    ['Z'] = {0x7E,0x06,0x0C,0x18,0x30,0x60,0x7E,0x00}, ['['] = {0x3C,0x30,0x30,0x30,0x30,0x30,0x3C,0x00},
    ['\\']= {0x00,0x60,0x30,0x18,0x0C,0x06,0x00,0x00}, [']'] = {0x3C,0x0C,0x0C,0x0C,0x0C,0x0C,0x3C,0x00},
    ['^'] = {0x18,0x3C,0x66,0x00,0x00,0x00,0x00,0x00}, ['_'] = {0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x00},
    ['`'] = {0x60,0x30,0x18,0x00,0x00,0x00,0x00,0x00}, ['a'] = {0x00,0x00,0x3C,0x06,0x3E,0x66,0x3E,0x00},
    ...
    ['f'] = {0x1C,0x30,0x7C,0x30,0x30,0x30,0x30,0x00}, ['g'] = {0x00,0x00,0x3E,0x66,0x66,0x3E,0x06,0x3C},
    ['h'] = {0x60,0x60,0x7C,0x66,0x66,0x66,0x66,0x00}, ['i'] = {0x18,0x00,0x38,0x18,0x18,0x18,0x3C,0x00},
    ['j'] = {0x0C,0x00,0x1C,0x0C,0x0C,0x0C,0x0C,0x38}, ['k'] = {0x60,0x60,0x66,0x6C,0x78,0x6C,0x66,0x00},
    ['l'] = {0x38,0x18,0x18,0x18,0x18,0x18,0x3C,0x00}, ['m'] = {0x00,0x00,0xEC,0xFE,0xD6,0xD6,0xD6,0x00},
    ...
    ['r'] = {0x00,0x00,0x5C,0x66,0x60,0x60,0x60,0x00}, ['s'] = {0x00,0x00,0x3E,0x60,0x3C,0x06,0x7C,0x00},
    ['t'] = {0x30,0x30,0x7C,0x30,0x30,0x30,0x1C,0x00}, ['u'] = {0x00,0x00,0x66,0x66,0x66,0x66,0x3E,0x00},
    ['v'] = {0x00,0x00,0x66,0x66,0x66,0x3C,0x18,0x00}, ['w'] = {0x00,0x00,0xC3,0xC3,0xDB,0xFF,0x66,0x00},
    ['x'] = {0x00,0x00,0x66,0x3C,0x18,0x3C,0x66,0x00}, ['y'] = {0x00,0x00,0x66,0x66,0x66,0x3E,0x06,0x3C},
